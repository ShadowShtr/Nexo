...
export const demoTrips = [
  { id: 'TEST-001', day: '2026-09-11', time: '09:00', end: '10:30', from: 'Aeroporto de Lisboa', to: 'Cascais', driver: 0, car: 0, customer: 0, cents: 12000, passengers: 2 },
  { id: 'TEST-002', day: '2026-09-11', time: '13:00', end: '17:00', from: 'Lisboa', to: 'Sintra · Cabo da Roca', driver: 0, car: 1, customer: 1, cents: 27000, passengers: 4 },
  { id: 'TEST-003', day: '2026-09-12', time: '10:00', end: '11:30', from: 'Parque das Nações', to: 'Setúbal', driver: 1, car: 2, customer: 2, cents: 15000, passengers: 2 },
  { id: 'TEST-004', day: '2026-09-12', time: '14:00', end: '18:00', from: 'Lisboa', to: 'Arrábida · Azeitão', driver: 2, car: 3, customer: 3, cents: 30500, passengers: 5 },
  { id: 'TEST-005', day: '2026-09-13', time: '08:00', end: '09:30', from: 'Estoril', to: 'Aeroporto de Lisboa', driver: 0, car: 0, customer: 4, cents: 12000, passengers: 2 },
  { id: 'TEST-006', day: '2026-09-13', time: '11:00', end: '15:00', from: 'Lisboa', to: 'Óbidos', driver: 1, car: 2, customer: 5, cents: 23500, passengers: 3 },
];
