...
const localLocations: readonly AddressSearchResult[] = [
  ...
  { title: 'Leiria', detail: 'Leiria, Portugal', coordinates: [39.7436, -8.8071], source: 'photon' },
  { title: 'Praias de Leiria', detail: 'Leiria, Portugal', coordinates: [39.843, -8.95], source: 'photon' },
  { title: 'Praia do Pedrógão', detail: 'Leiria, Portugal', coordinates: [39.9126, -8.9501], source: 'photon' },
];
const tourPhotos = [
  { path: '/lisbon-sintra-tour.webp', label: 'Lisboa e Sintra' },
  { path: '/porto-tour.webp', label: 'Porto e Douro' },
  { path: '/route-landmark.webp', label: 'Rota personalizada' },
] as const;
const initial: Tour[] = [
  { id: 't1', namePt: 'Sintra e Cabo da Roca', nameEn: 'Sintra and Cabo da Roca', descriptionPt: 'Palácios, costa e miradouros.', descriptionEn: 'Palaces, coast and viewpoints.', durationDays: 2, baseCents: 20000, extraPassengerCents: 3500, minimumNoticeHours: 48, active: true, area: 'Sintra', photoPath: '/lisbon-sintra-tour.webp', location: localLocations[1] },
  { id: 't2', namePt: 'Douro Premium', nameEn: 'Premium Douro', descriptionPt: 'Vinhos e paisagens do Douro.', descriptionEn: 'Wine and Douro landscapes.', durationDays: 2, baseCents: 32000, extraPassengerCents: 4500, minimumNoticeHours: 72, active: true, area: 'Douro', photoPath: '/porto-tour.webp', location: localLocations[4] },
];
