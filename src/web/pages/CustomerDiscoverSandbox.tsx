...
export default function CustomerDiscoverSandbox() {
  ...
  const customCalendarTimes = useMemo(() => bookingTimesForDate(customCalendarDate), [customCalendarDate, ownerCalendar, serviceDurationMinutes]);
