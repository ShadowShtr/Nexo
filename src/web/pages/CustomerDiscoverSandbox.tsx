...
export default function CustomerDiscoverSandbox() {
  ...
  const selectedBookingDate = availableBookingDates.some(day => day.value === bookingStart.slice(0, 10)) ? bookingStart.slice(0, 10) : availableBookingDates[0]?.value ?? bookingStart.slice(0, 10);
