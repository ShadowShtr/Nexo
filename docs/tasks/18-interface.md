...
Evidência parcial 0.2.84: barra inicial de pesquisa compacta, botões e caixas de planeamento menores, ícones alinhados, um único resumo de booking, cartões finais separados, calendário principal com horários e pop-up próprio arredondado de data sem grelha duplicada, e bandeiras no seletor de idioma, incluindo a opção ativa; build e browser focado aprovados. Ver docs/10-validacao.md. UI-02 permanece em curso.
