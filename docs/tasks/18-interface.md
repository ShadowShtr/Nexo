...
Evidência parcial 0.2.87: barra inicial de pesquisa compacta, botões e caixas de planeamento menores, ícones alinhados, um único resumo de booking, cartões finais separados, calendário principal com horários e pop-up próprio arredondado de data sem grelha duplicada, e bandeiras PNG maiores sem moldura quadrada no seletor de idioma, sem planeta duplicado, incluindo a opção ativa e a bandeira dos Estados Unidos para inglês; build e browser focado aprovados. Ver docs/10-validacao.md. UI-02 permanece em curso.
