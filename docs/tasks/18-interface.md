...
Evidência parcial 0.2.81: barra inicial de pesquisa compacta, botões e caixas de planeamento menores, ícones alinhados, um único resumo de booking e calendário principal com horários e pop-up próprio arredondado de data sem grelha duplicada; build e browser focado aprovados. Ver docs/10-validacao.md. UI-02 permanece em curso.
