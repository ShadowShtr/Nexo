...
1. **Para onde vai?** A descoberta abre os campos e o mapa na mesma tela, sem trocar de aba. O mapa começa centrado na origem sugerida; após escolher o destino, mostra a rota e aguarda “Ver rota e preço” para confirmar a cotação. Entrada com PT/EN acessível, destino como ação principal, locais recentes e mapa após o cálculo. Origem sugerida pela localização atual após autorização; confirmar endereço/pino, permitindo editar sempre. Sem autorização, precisão suficiente ou localização disponível, preencher a origem manualmente. Não pedir localização repetidamente nem tratar a posição aproximada como recolha confirmada.
