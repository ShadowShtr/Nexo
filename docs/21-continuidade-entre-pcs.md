...
Atualizado em 16/09/2026. Código de referência: v0.2.84. A documentação acompanha as alterações visuais do calendário, do planeador, do resumo de booking e do seletor de idioma; o fluxo continua em demonstração.
