...
Atualizado em 16/09/2026. Código de referência: v0.2.79. A documentação acompanha as alterações visuais do calendário e do planeador; o fluxo continua em demonstração.
