# Plataforma de transporte premium — base web 0.2.88
...
Aplicação de referência: v0.2.88. Os documentos antigos registam evidência por versão; a demonstração guarda o pedido completo e algumas configurações em localStorage apenas neste navegador, sem sincronização entre PCs. Assets necessários estão versionados em public.
