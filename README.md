# Plataforma de transporte premium — base web 0.2.90
...
Aplicação de referência: v0.2.90. O painel demo do proprietário tem agora resumo operacional, próximas marcações e ações rápidas; a aba Reservas permite criar marcações manuais com localização, paragens, rota completa, data/hora e recursos. A demonstração guarda o pedido completo e algumas configurações em localStorage apenas neste navegador, sem sincronização entre PCs. Assets necessários estão versionados em public.
