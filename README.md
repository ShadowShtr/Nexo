# Plataforma de transporte premium — base web 0.2.85
...
Aplicação de referência: v0.2.85. Os documentos antigos registam evidência por versão; a demonstração em sessionStorage não sincroniza reservas entre PCs. Assets necessários estão versionados em public.
