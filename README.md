# Plataforma de transporte premium — base web 0.2.25
...
API operacional ligada às abas, catálogo persistente, consulta autenticada, notificações, cálculo rodoviário real, MB WAY e reembolsos reais. A interface autenticada e as migrações foram validadas apenas no Supabase local; nenhum projeto Supabase remoto foi ligado.
